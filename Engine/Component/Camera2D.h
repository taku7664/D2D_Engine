...
public:
    ...
    void         SetLayerCulling(LayerType _type, bool _isculling) { m_cullingLayer[(int)_type] = _isculling; }
...
private:
    ...
    bool m_cullingLayer[(int)LayerType::SIZE]{ false, }; // true일 시 렌더링에서 제외한다.
